...
let addStudent = (carnet, schedule, late)=>{
    ...
    new_row.className = 'table-active' //nuevo tr tendra la clase table active.
...
submit_btn.addEventListener('click', ()=>{
    ...
    //opciones que tienen como un arreglo, especificando cual queremos.
